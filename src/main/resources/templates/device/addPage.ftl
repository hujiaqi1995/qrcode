...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-8">
        <div class="divForm">
            <form action="/device/add" method="post" class="form-horizontal">
                <div class="form-group">
                    <div for="fordeviceName" class="col-sm-2 control-label">设备名称:</div>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="fordeviceName" name="deviceName" required>
                    </div>
                </div>
                <div class="form-group">
                    <div for="fordeviceDate" class="col-sm-2 control-label">购置日期:</div>
                    <div class="col-sm-3">
                        <input type="date" class="form-control" id="fordeviceDate" name="date" value="2019-01-01" required>
                    </div>
                </div>
                <div class="form-group">
                    <div for="fordevicePrice" class="col-sm-2 control-label">对内造价:</div>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="fordevicePrice" name="price" required>
                    </div>
                </div>
                <div class="form-group">
                    <div for="fordeviceAddress" class="col-sm-2 control-label">存放地址:</div>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="fordeviceAddress" name="address" required>
                    </div>
                </div>
                <div class="form-group">
                    <div for="fordevicePrincipal" class="col-sm-2 control-label">责任人:</div>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="fordevicePrincipal" name="principal" required>
                    </div>
                </div>
                <div class="form-group">
